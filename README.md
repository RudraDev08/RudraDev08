...
🌱 Learning: UI/UX design with Figma & advanced backend concepts

🧠 Strong In: JavaScript logic, React state management, REST APIs

💬 Ask Me About: React, JavaScript, APIs, CRUD systems, app architecture
